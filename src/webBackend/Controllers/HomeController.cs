...
public class HomeController : Controller
{
    ...
    public HomeController(AgoraDbContext context, SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager, IEmailSender emailSender)
    {
        _context = context;
    ...
    {
        var urunler = _context.Products.Where(product => product.IsActive).ToList();
